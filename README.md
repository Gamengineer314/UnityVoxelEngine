...
- Indirect rendering and instancing (using Graphics.RenderPrimitivesIndexedIndirect) for minimal CPU-GPU interactions (1 compute dispatch + 1 draw call per layer, shader, and camera)
